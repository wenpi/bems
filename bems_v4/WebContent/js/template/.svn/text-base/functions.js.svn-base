...
$(document).ready(function(){
    ...
    $("ul.navigation #egergy_save_look").click(function(){
        $("#container_of_index_page .contentbox").load("html/energySave/energySave.look.html");
    });
    
    $("ul.navigation #egergy_save_pubilshTask").click(function(){
        $("#container_of_index_page .contentbox").load("html/energySave/energySave.pubishTask.html");
    });
